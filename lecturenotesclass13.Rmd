...
I'd expect around 5 to be left handed, give or take a few. I would be very 
surprised if 40 were left handed, but not at all suprised if 3 were.
...
```{r data_manhattan}
manhattan <- read_csv("~/R/lecture-note-class-13-sophiejohnson23/manhattan.csv")
```
...
- Parameter of interest: mean price of 1-bedroom apartments in Manhattan
- Sample: 1-bedroom apartments in Manhattan
- Sample size: n=20 1-bedroom apartments 
...
- Population: mice given treatment
- Parameter of interest: proportion of mice that died while not on the treatment
- Sample: mice given treatment
- Sample size: n=522 mice
...
Somewhere between 69%-79.7% of the mice died while not on the treatment. 
...
Somewhere between 69.7%-78.9% of the mice died while not on the treatment. 
